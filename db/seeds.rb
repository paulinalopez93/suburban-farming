...
Product.create!(name: "Broccoli", price: 5, details: "Broccoli is in season year around and its harvested by hand with a crisp texture and full flavor. Broccoli can be used in many dishes such as whole grain pasta primavera, casseroles such as brown rice and broccoli casserole, or roasted with a little oil and seasonings.", category: "vegetables", user_id:alex.id, remote_photo_url:"https://images.unsplash.com/photo-1553175005-a1129d5c188c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=802&q=80")

Product.create!(name: "Corn", price: 2, details: "Corn is carefully grown to be tender and bursting with flavor. We carefully select different varieties to be grown so that they are sweet and juicy.", category: "vegetables", user_id:adam.id, remote_photo_url:"https://images.unsplash.com/photo-1554402100-8d1d9f3dff80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80")

Product.create!(name: "Mushrooms", price: 2, details: "Mushrooms are very versatile and equally tasty, fresh or cooked. Use raw in salads, sautéed, breaded or as an ingredient to enrich sauces, soups, stuffing or entrées.", category: "vegetables", user_id:adel.id, remote_photo_url:"https://images.unsplash.com/photo-1504545102780-26774c1bb073?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=730&q=80")

Product.create!(name: "Carrots", price: 1, details: "A delicious orange carrot", category: "vegetables", user_id:paulina.id, remote_photo_url:"https://images.unsplash.com/photo-1550081699-79c1c2e48a77?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80")
...
Product.create!(name: "Brussels sprouts", price: 5, details: "A delicious brussel sprout", category: "vegetables", user_id:sofia.id, remote_photo_url:"https://images.unsplash.com/photo-1438118907704-7718ee9a191a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80")
...
Product.create!(name: "Grapes", price: 2, details: "Tiny green grapes", category: "fruits", user_id:adam.id, remote_photo_url:"https://images.unsplash.com/photo-1515779122185-2390ccdf060b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80")

Product.create!(name: "Strawberries", price: 2, details: "Strawberries full of flavor", category: "fruits", user_id:adel.id, remote_photo_url:"https://images.unsplash.com/photo-1543528176-61b239494933?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1653&q=80")
...
Product.create!(name: "Lemons", price: 1, details: "Yummy Lemons", category: "fruits", user_id:sofia.id, remote_photo_url:"https://images.unsplash.com/photo-1501621178796-25b923c8b5de?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80")

Product.create!(name: "Blueberries", price: 5, details: "The best berries! Blueberries!", category: "fruits", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1502741338009-cac2772e18bc?ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80")

Product.create!(name: "Peaches", price: 3, details: "A delicious peach", category: "fruits", user_id:mariana.id, remote_photo_url:"https://images.unsplash.com/photo-1521243495304-138a02be58e2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80")

Product.create!(name: "Pineapple", price: 2, details: "A delicious pineapple", category: "fruits", user_id:jorge.id, remote_photo_url:"https://images.unsplash.com/photo-1478005344131-44da2ded3415?ixlib=rb-1.2.1&auto=format&fit=crop&w=2848&q=80")
...
Product.create!(name: "White eggs", price: 3, details: "White eggs from chickens", category: "eggs", user_id:alfredo.id, remote_photo_url:"https://images.unsplash.com/photo-1489726933853-010eb1484d1a?ixlib=rb-1.2.1&auto=format&fit=crop&w=2090&q=80")

#wine
Product.create!(name: "White wine", price: 8, details: "Deliciuos white wine", category: "wine", user_id:adel.id, remote_photo_url:"https://images.unsplash.com/photo-1561916542-c981c30f0cdb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=738&q=80")
...
#herbs
Product.create!(name: "Parsley", price: 3, details: "Deliciuos parsley", category: "herbs", user_id:paulina.id, remote_photo_url:"https://images.unsplash.com/photo-1553217420-e8f8dde808f7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1627&q=80")

Product.create!(name: "Mint", price: 5, details: "Mint so refreshing that you won't know what hit you", category: "herbs", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1509727841791-40d09ad9b7fc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80")

Product.create!(name: "Basil", price: 6, details: "Perfect basil", category: "herbs", user_id:sofia.id, remote_photo_url:"https://images.unsplash.com/photo-1527964105263-1ac6265a569f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80")
